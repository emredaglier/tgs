  ...
  return (
    <>
      <section className="flex flex-row w-full justify-between">
        ...
        shadow-2xl shadow-[--accent] rounded-br-3xl py-2 justify-center items-center
...
const HomeAbout = () => {
  return (
    <>
      <section
        className="relative flex w-full h-min rounded-t-3xl md:py-[96px] lg:py-[196px] xl:py-[256px] 2xl:py-[384px] bg-[--background]"
        style={{ zIndex: 2 }}
      >
        <ImageSection
          head="About"
