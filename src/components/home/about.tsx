  ...
  return (
    <>
      <section className="flex flex-row w-full justify-between">
        <div className="flex flex-col rounded-tl-3xl rounded-br-3xl py-2 justify-center items-center w-[96px] h-[96px] 2xl:w-[120px] 2xl:h-[120px] min-[2000px]:w-[160px] min-[2000px]:h-[160px] transition-all duration-1000 bg-[--accent] text-white">
