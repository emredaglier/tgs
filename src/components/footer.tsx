  ...
  return (
    <>
      <div className="flex flex-col gap-4">
        <h1 className="text-xl underline font-medium text-[--accent] dark:text-[--foreground] transition-colors duration-1000">
          {head}
        </h1>
...
const Footer = () => {
  ...
  return (
    <>
      <footer
        className={`flex flex-col bg-[--background] py-[90px] gap-16 ${margin} transition-colors duration-1000 border-t`}
      >
